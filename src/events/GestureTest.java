...
//http://www.java2s.com/Tutorials/Java/JavaFX/1130__JavaFX_Gesture_Events.htm
//The following events for Touch-Enabled Devices are supported 
	...
	public void start(Stage primaryStage) {
		...
		rect.setOnZoom(new EventHandler<ZoomEvent>() {
			...
			public void handle(ZoomEvent event) {
				...
				System.out.println(
						"Rectangle: Zoom event" + ", inertia: " + event.isInertia() + ", direct: " + event.isDirect());
