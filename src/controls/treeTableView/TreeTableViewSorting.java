...
public class TreeTableViewSorting extends Application {
...
//      );
        ...
        firstNameCol.setSortType(TreeTableColumn.SortType.DESCENDING);
        lastNameCol.setSortType(TreeTableColumn.SortType.ASCENDING);
        tree.getSortOrder().addAll(firstNameCol, lastNameCol);
        
        //tree.setSortMode(TreeSortMode.ALL_DESCENDANTS);			//all tree items
        //tree.setSortMode(TreeSortMode.ONLY_FIRST_LEVEL);			//only first-level nodes
